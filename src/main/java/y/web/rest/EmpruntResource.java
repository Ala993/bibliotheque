...
import y.service.EmpruntService;
import y.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link y.domain.Emprunt}.
 */
@RestController
@RequestMapping("/api")
public class EmpruntResource {
    ...
    public ResponseEntity<Emprunt> updateEmprunt(@PathVariable(value = "id", required = false) final Long id, @RequestBody Emprunt emprunt)
    ...
    public ResponseEntity<Emprunt> partialUpdateEmprunt(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, emprunt.getId().toString())
        );
    }
